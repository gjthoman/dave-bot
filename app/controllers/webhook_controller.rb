class WebhookController < ApplicationController
  ...
  def how_much_vehicle
    ...
    "Dave recommends that the total cost of everything you own that goes down in value be less than half of your annual take home pay. In your case, the total of stuff you own going down in value should be no more than $#{income.to_i/2}."
  end
end
